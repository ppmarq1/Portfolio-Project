const workData = [
  ...
  },
  {
    ...
    tech: ['React & Redux', 'HTML', 'CSS', 'javascript'],
    demoUrl: 'https://github.com/ppmarq1/Bookstore-react',
    gitUrl: 'https://github.com/ppmarq1/Bookstore-react',
  },
  {
    name: 'Math <br> Magicians',
    description:
  ...
  {
    name: 'Space Hub  <br> Project Group ',
    description:
    ...
    ImgUrl: 'space.png',
    tech: ['React & Redux', 'CSS', 'Javascript', 'HTML', 'Bootstrap', 'Netlify'],
